            ...
            switch ($action)
            {
                ...
                case "del":
                    ...
                    $SHANDataOP1->deleteDataWithKey($db_table,$item_id);
                     ...
                     // 將此日報表的組別原物料做更新   
                     $EngineeringDailyReport1 = new EngineeringDailyReport();
                     $EngineeringDailyReport1->re_update_this_project_meterial_inventory_in_engineering_daily_report_id($item_id); 
...
<div id="main">
    <div id="<?php echo str_replace('.php','',$first_page);?>">
...
<?php 
	$sqlop1 = new SqlOperator($db_worker);
        ...
        $ListForLooking1->dbInit($db_table, $show_db_item, $relation, $order_by, $condition,$in_condition);
