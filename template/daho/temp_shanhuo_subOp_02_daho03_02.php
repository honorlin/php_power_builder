        ...
        $(document).ready(function () {
           ...
           setTimeout(parent.parent.doIframe,500);
            ...
            $(".item_value").change(function() {
                ...
                if($(this).attr("id") == "item_9") return;
                
                var all_count = parseFloat($("#item_3").val());
                if($("#item_4").val() != "") all_count += parseFloat($("#item_4").val());
                if($("#item_5").val() != "") all_count += parseFloat($("#item_5").val());
                if($("#item_6").val() != "") all_count += parseFloat($("#item_6").val());
                if($("#item_7").val() != "") all_count += parseFloat($("#item_7").val());
                if($("#item_8").val() != "") all_count += parseFloat($("#item_8").val());
                
                $("#item_9").val(all_count);
                $("#item_10").val(parseFloat($("#item_2").val()) * all_count);
