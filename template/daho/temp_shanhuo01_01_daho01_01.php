...
<?php
	...
	$sqlop1 = new SqlOperator($db_worker);
        ...
        if($op_edit) $process[] = array("add","基本建檔","<a title=\"工程基本建檔\" href=\"$second_page?ac=edit&id=@primarykey@\"><img src=\"img/edit2.png\" border=\"0\" width=\"25\"/></a>");   
        if($op_edit) $process[] = array("add","建立日報表","<a title=\"建立日報表\" href=\"1002.php?id=@primarykey@\"><img src=\"img/1351234330_Paper-add.png\" border=\"0\" width=\"30\"/></a>");
        if($op_edit) $process[] = array("add","查看日報表","<a title=\"查看日報表\" href=\"1001.php?project_id=@primarykey@\"><img src=\"img/1351234523_report.png\" border=\"0\" width=\"25\"/></a>");
