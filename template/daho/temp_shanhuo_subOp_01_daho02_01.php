...
<meta http-equiv="Content-Type" content="text/html; charset=utf-8" />
    <title></title>
        ...
        $(document).ready(function () {
           ...
           setTimeout(parent.parent.doIframe,500);// 0.5s後 讓父視窗更新iframe高度 
           setTimeout(cacuAllLen,500);           
        ...
        function cacuAllLen()
        {
            ...
            $(".r3").each(function(index){
                $alllen += parseFloat($(this).html());                
            });           
            
            $("#item_11",parent.document.body).val($alllen);
            ...
            $("#item_10",parent.document.body).val($alllen);
            
          //  $("#item_16",parent.document.body).trigger('change');
            
           /*
  
        var inpt = $("#item_17",parent.document.body);
        
        inpt.css('border',"solid 1px #333");
        
        var delay = 300;
        inpt.animate({ borderWidth : "3px"}, 200,function(){
            //revert after completing
            inpt.animate({ borderWidth : "1px" }, 200);
            inpt.css('border',"solid 1px #ccc");
            });
        */
        }
